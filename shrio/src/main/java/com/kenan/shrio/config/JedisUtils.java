...
public class JedisUtils {
    ...
    public static void initJedisCluster(String address,String password) {
        JedisUtils.address = address;
    ...
    /**
     * address:  127.0.0.1:1111,127.0.0.1:2222
     * @return
     */
    private static JedisCluster getJedisCluster(){
                ...
                if (INSTANCE_INIT_LOCL.tryLock(2, TimeUnit.SECONDS)) {
                    try {
                        if (jedisCluster == null) {
                            ...
                            jedisCluster = new JedisCluster(set,5000,2000,2,password,new GenericObjectPoolConfig());
                            logger.info(">>>>>>>>>>> shrio, JedisUtil.jedisCluster init success.");
                        }
        ...
        if (jedisCluster == null) {
            throw new NullPointerException(">>>>>>>>>>> shrio, JedisUtil.jedisCluster is null.");
        }
        return jedisCluster;
    }
    ...
    private static ShardedJedis getInstance() {
                ...
                if (INSTANCE_INIT_LOCL.tryLock(2, TimeUnit.SECONDS)) {
                    ...
                    try {
                        ...
                        if (shardedJedisPool == null) {
                            ...
                            logger.info(">>>>>>>>>>> shrio, JedisUtil.ShardedJedisPool init success.");
                        }
        ...
        if (shardedJedisPool == null) {
            throw new NullPointerException(">>>>>>>>>>> shrio, JedisUtil.ShardedJedisPool is null.");
        }
    ...
    public static String setStringValue(String key, String value, int seconds) {
        String result = null;
        JedisCluster client = getJedisCluster();
        try {
    ...
    public static void main(String[] args) {
        ...
        initJedisCluster("172.30.66.155:7000,172.30.66.154:7002,172.30.66.153:7004","19e.com.cn");
